...
class Translation:
    def __init__(self, alien_lang, text_to_translate):
        ...
        self.alien_text = Label(self.parent, text=text_to_translate)
        self.alien_text.grid(row=0, column=3, rowspan=6, sticky=W)

        self.english_text = Label(self.parent, text=text_to_translate)
        self.english_text.grid(row=7, column=3, rowspan=6, sticky=W)
        self.alien_var = StringVar()
        self.alien_label = Label(self.parent, text='Alien:')
        ...
        self.english_label = Label(self.parent, text='English:')
        ...
        self.translate_button = Button(self.parent, text='Translate', command=self.test_translation)
